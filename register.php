...
if(isset($_POST['register'])){
    ...
    $request = "INSERT INTO users (login,email,  password) VALUES ('$login', '$email', '$password')";
    $pdo->query($request);
    ...
    <main>
        <div class="main-container">
            ...
            <form action="" method="post" class="auth-form">
                ...
                <br>
                <input type="text" name="email" placeholder="Введите эл. почту" class="auth-input">
                <br>
                <input type="text" name="password" placeholder="Введите пароль" class="auth-input">
                <br>
                <button type="submit" name="register" class="auth-btn">Cоздать</button>
            </form>
            <p class="auth-reg"><a href="register.php">Есть аккаунта? Войти</a></p>
        </div>
    </main>
    <footer>
